...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #178386 0%, #126C70 100%); padding: 32px 20px; color: #FFFFFF; }
        .header h1 { margin: 0; font-size: 24px; font-weight: 800; letter-spacing: 0.5px; }
        .header p { margin: 6px 0 0 0; font-size: 14px; opacity: 0.9; }
        .content { padding: 36px 28px; }
        .greeting { font-size: 18px; font-weight: 700; color: #142D2D; margin-bottom: 12px; }
        .description { font-size: 14px; color: #64748B; line-height: 1.6; margin-bottom: 28px; }
        .otp-container { background: #F2F8F8; border: 2px dashed #178386; border-radius: 18px; padding: 20px; margin: 0 auto 28px auto; display: inline-block; min-width: 220px; }
        .otp-code { font-size: 40px; font-weight: 900; color: #178386; letter-spacing: 14px; margin-right: -14px; font-family: 'Courier New', Courier, monospace; }
        .expiry-badge { display: inline-flex; align-items: center; background: #FAF3E8; color: #B88E52; border: 1px solid #E1C7A2; padding: 6px 14px; border-radius: 20px; font-size: 12.5px; font-weight: 700; margin-bottom: 24px; }
        .footer { background: #F1F5F9; padding: 20px; font-size: 12px; color: #7C8987; border-top: 1px solid #E2E8F0; }
        .footer a { color: #178386; text-decoration: none; font-weight: bold; }
    </style>
</head>
<body>
    <div class="wrapper">
        <div class="email-card">
            <div class="header">
                <h1>🚚 سُودرا للخدمات اللوجستية</h1>
                <p>{$actionTitle}</p>
            </div>
            <div class="content">
                <div class="greeting">مرحباً بك،</div>
                <div class="description">
                    لتأكيد طلبك والمتابعة في تطبيق سودرا للشحن (SUDRA Express & Logistics)، يرجى إدخال رمز التحقق (OTP) التالي في التطبيق:
                </div>
                ...
                <div style="font-size: 12.5px; color: #7C8987; margin-top: 15px;">
                    إذا لم تكن أنت من قام بهذا الطلب، يمكنك تجاهل هذه الرسالة بأمان.
                </div>
            </div>
            <div class="footer">
                © 2026 سُودرا للشحن والخدمات اللوجستية • <a href="https://app.sudra.sa">app.sudra.sa</a>
            </div>
        </div>
    </div>
</body>
